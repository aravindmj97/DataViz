...
time ogr2ogr -f CSV -lco GEOMETRY=AS_XY -select BaseDateTime -s_srs EPSG:4269 -t_srs EPSG:3857 -oo X_POSSIBLE_NAMES=LON -oo Y_POSSIBLE_NAMES=LAT AISstored.csv 1.csv
